<header class="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-6">
    ...
    <div>
        ...
        <p class="text-sm text-gray-500">AutoCar Fleet Management</p>
    </div>
    {{-- Right --}}
    <div class="flex items-center gap-5">
        ...
        <div class="hidden md:flex items-center">
            <div class="relative">
                <input type="text" placeholder="Search..." class="w-64 rounded-lg border border-gray-200 bg-gray-50 px-4 py-2 pl-10 text-sm focus:border-blue-500 focus:ring-blue-500">
